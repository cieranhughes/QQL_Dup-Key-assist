...
VALUES (
		...
		"Theres nothing more frustrating or stressful than accidentally locking your keys inside your vehicle, especially if you have somewhere you need to be urgently. Being locked outside of a car is, however, much more common than you may think. There are a few reasons why you may be facing the tricky situation of being locked outside your car, including:",
...
(
		1,
		"Download the app",
		"Many modern car's (petrol/diesel and electric) come with an app that you can download, which has useful services for you to benefit from if you need them. Most apps will allow you to unlock (and even lock) your vehicle without the need for a key, so be sure to check if you have this feature."
	),
(
		1,
		"Call a specialist",
